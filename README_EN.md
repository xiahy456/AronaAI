...
**A non-interactive desktop AI based on Arona from *Blue Archive***

*The cloud handles planning and extraction; the local model handles persona and the immersive scene. Relationship tensors and proactive events form a rule-based control plane — this is not just another chatting LLM.*
...
*Desktop client screenshot — Arona & Setting Widget*
...
- **llama.cpp / llama-cpp-python** — local GGUF inference ([https://github.com/ggml-org/llama.cpp](https://github.com/ggml-org/llama.cpp))
- **Qwen3-1.7B** — fine-tune base model ([https://huggingface.co/Qwen/Qwen3-1.7B](https://huggingface.co/Qwen/Qwen3-1.7B))
- **Unsloth** — efficient QLoRA fine-tuning ([https://unsloth.ai/](https://unsloth.ai/))
- **ChromaDB** — vector database ([https://www.trychroma.com/products/chromadb](https://www.trychroma.com/products/chromadb))
- **DeepSeek** — Planner intent planning and memory extraction API ([https://www.deepseek.com/](https://www.deepseek.com/))
- **GPT-SoVITS** — speech synthesis ([https://github.com/RVC-Boss/GPT-SoVITS](https://github.com/RVC-Boss/GPT-SoVITS))
- **Tencent Cloud ASR** — online speech recognition ([https://cloud.tencent.com/product/asr](https://cloud.tencent.com/product/asr))
- **bge-small-zh-v1.5** — text embedding model ([https://huggingface.co/BAAI/bge-small-zh-v1.5](https://huggingface.co/BAAI/bge-small-zh-v1.5))

**Thanks to everyone who helped with development, and to the Blue Archive community**

**Thank you for the amazing works and energy you bring to this community**
...
- **Blog**: [https://xia-hy456.top/](https://xia-hy456.top/)
- **Feedback**: [2066961858@qq.com](mailto:2066961858@qq.com)
